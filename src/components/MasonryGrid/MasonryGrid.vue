  ...
  <div class="masonry-grid">
    ...
    <div
      ...
      <div>Try searching for
        <router-link :to="{ name: 'search-results', params: { searchTerm: 'c3po' }}">C3PO</router-link> or
        <router-link :to="{ name: 'search-results', params: { searchTerm: 'r2d2' }}">R2D2</router-link>.
      </div>
    </div>
